questions = ["1. Aaron and Milan are friends and _______ of them go to the same school. They are classmates, too ",
    ...
    "20. _______ of the five girls has short black hair. _______ of them have long brown hair 914254484"
]
...
b = ["B. both", "B. all / both", "B. both", "B.","B. all",  "B. None of", "B. both", "B. Both / None", "B. none of", "B. neither of", "B. neither of", "B. both", "B. all / both", "B. both", "B.","B. all",  "B. None of", "B. both", "B. Both / None", "B. none of", "B. neither of", "B. neither of"]
...
d = ["D. neither", "D. none /all", "D. all", "D.", "D. neither", "D. Neither of", "D. all of", "D. All / Neither", "D. all", "D. none of", "D. none of", "D. neither", "D. none /all", "D. all", "D.", "D. neither", "D. Neither of", "D. all of", "D. All / Neither", "D. all", "D. none of", "D. none of"]
document.querySelector(".botton1").addEventListener('click', ()=>{
...
document.querySelector(".botton2").addEventListener('click', ()=>{
...
document.querySelector(".botton3").addEventListener('click', ()=>{
...
document.querySelector(".botton4").addEventListener('click', ()=>{
...
document.querySelector(".botton5").addEventListener('click', ()=>{
...
document.querySelector(".botton6").addEventListener('click', ()=>{
...
document.querySelector(".botton7").addEventListener('click', ()=>{
...
document.querySelector(".botton8").addEventListener('click', ()=>{
...
document.querySelector(".botton9").addEventListener('click', ()=>{
...
document.querySelector(".botton10").addEventListener('click', ()=>{
...
document.querySelector(".botton11").addEventListener('click', ()=>{
...
document.querySelector(".botton12").addEventListener('click', ()=>{
...
document.querySelector(".botton13").addEventListener('click', ()=>{
...
document.querySelector(".botton14").addEventListener('click', ()=>{
...
document.querySelector(".botton15").addEventListener('click', ()=>{
...
document.querySelector(".botton16").addEventListener('click', ()=>{
...
document.querySelector(".botton17").addEventListener('click', ()=>{
...
document.querySelector(".botton18").addEventListener('click', ()=>{
...
document.querySelector(".botton19").addEventListener('click', ()=>{
...
document.querySelector(".botton20").addEventListener('click', ()=>{
...
count = -1
document.querySelector(".test-setting-button-next").addEventListener("click", ()=>{
    count +=1
...
document.querySelector(".test-setting-button-prev").addEventListener("click", ()=>{
    count -=1
    document.querySelector(".test-question-text").textContent = questions[count]
    document.querySelector(".A").textContent = a[count]
    document.querySelector(".B").textContent = b[count]
